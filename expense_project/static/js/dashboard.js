...
const renderExpenseChart = (e, t, a, n) => {
    var r = document.getElementById("myChart").getContext("2d");
  ...
  getChartData = (e) => {
    fetch("/expense/expense-summary-data?filter=month")
      .then((e) => e.json())
      .then((t) => {
      ...
      fetch("/income/income-summary-data?filter=month")
        .then((e) => e.json())
        .then((t) => {
